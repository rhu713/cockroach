...
`); err != nil {
	...
	// a state machine that increments the version by 7.
	expectedVersion := tableDesc.Version + 7
...
`); err != nil {
	...
	expected := []string{
		...
		fmt.Sprintf("Put /Table/%d/4/2/0 -> /BYTES/0x0a030a1302", tableID),
		// TODO (rohany): this k/v is spurious and should be removed
		//  when #45343 is fixed.
		fmt.Sprintf("Put /Table/%d/4/2/1/1 -> /BYTES/0x0a020104", tableID),
		fmt.Sprintf("Put /Table/%d/4/2/2/1 -> /BYTES/0x0a030a3306", tableID),
		fmt.Sprintf("Put /Table/%d/4/2/4/1 -> /BYTES/0x0a02010c", tableID),
	...
	expected = []string{
		...
		fmt.Sprintf("Put (delete) /Table/%d/4/2/0", tableID),
		fmt.Sprintf("Put (delete) /Table/%d/4/2/1/1", tableID),
		fmt.Sprintf("Put (delete) /Table/%d/4/2/2/1", tableID),
		fmt.Sprintf("Put (delete) /Table/%d/4/2/3/1", tableID),
		fmt.Sprintf("Put (delete) /Table/%d/4/2/4/1", tableID),
	...
	expected = []string{
		...
		fmt.Sprintf("Put /Table/%d/4/3/0 -> /BYTES/0x0a030a1302", tableID),
		fmt.Sprintf("Put /Table/%d/4/3/1/1 -> /BYTES/0x0a020106", tableID),
		fmt.Sprintf("Put /Table/%d/4/3/2/1 -> /BYTES/0x0a030a3306", tableID),
		fmt.Sprintf("Put /Table/%d/4/3/4/1 -> /BYTES/0x0a02010c", tableID),
	...
	expected = []string{
		...
		// sense.
		fmt.Sprintf("Put /Table/%d/4/3/3/1 -> /BYTES/0x0a02010a", tableID),
	}
	require.Equal(t, expected, scanToArray(rows))
