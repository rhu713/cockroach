...
`); err != nil {
	...
	expected := []struct {
		...
		{"test_d_key1", 1, descpb.DescriptorMutation_DELETE_ONLY},
		{"e", 1, descpb.DescriptorMutation_DELETE_ONLY},
		{"test_e_key", 1, descpb.DescriptorMutation_BACKFILLING},
		{"test_e_key1", 1, descpb.DescriptorMutation_DELETE_ONLY},
		...
		{"test_f_key", 2, descpb.DescriptorMutation_DELETE_ONLY},
		// Third.
		{"idx_g", 3, descpb.DescriptorMutation_BACKFILLING},
		{"test_g_key", 3, descpb.DescriptorMutation_DELETE_ONLY},
