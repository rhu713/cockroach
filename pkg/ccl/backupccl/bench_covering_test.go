...
//							manifests := make([]BackupManifestV2, len(backups))
//							for j := range backups {
//								manifests[j] = &backups[j]
//							}
//							b.ResetTimer()
//							for i := 0; i < b.N; i++ {
//								if err := checkCoverageRestore(ctx, backups[numBackups-1].Spans, manifests); err != nil {
//									b.Fatal(err)
//								}
//							}
//						})
...
//									b.Fatal(err)
//								}
//								cov := makeSimpleImportSpans(backups[numBackups-1].Spans, manifests, nil, nil)
